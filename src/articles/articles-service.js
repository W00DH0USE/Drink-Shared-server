...
const ArticlesService = {
  getAllArticles(db) {
    return db
      ...
      .leftJoin(
        'sociare_comments AS comm',
        'art.id',
        'comm.article_id',
      )
      .leftJoin(
        'sociare_users AS usr',
        'art.author_id',
        'usr.id',
      )
  ...
  serializeArticle(article) {
    ...
    return {
      ...
      ingredients: xss(article.ingredients),
      directions: xss(article.directions),
